...
from electronics_power_graph import electronics_power_graph_main
...
if __name__ == "__main__":
    ...
    #create processes
    p_tcp_client = multiprocessing.Process(target=tcp_client_main, args=(volt1,volt2,actuator_amp,motor_amp,electronics_amp))
    ...
    p_electronics_power_graph = multiprocessing.Process(target=electronics_power_graph_main, args=(electronics_amp,volt1))
    ...
    p_electronics_power_graph.start()
    ...
    p_electronics_power_graph.terminate()
